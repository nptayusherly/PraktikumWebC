                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php while ($data = mysqli_fetch_assoc($queryKRS)) { ?>
                                                ...
                                                <tr>
                                                    <td><?= $i; ?></td>
                                                    <td><a href="krs_edit.php?id_krs=<?= $data['id_krs']; ?>" class="badge badge-primary ">Edit</a> | <a href="function.php?act=hapusKRS&id_krs=<?= $data['id_krs']; ?>" onclick="return confirm('Yakin ingin menghapus KRS?');" class="badge badge-danger ">Hapus</a></td>
                                                    <?php if ($default == true) : ?>
                                                        <th><?= $data['semester'] ?></th>
                                                    <?php endif ?>
                                                    <td><?= $data['kode_mk']; ?></>
