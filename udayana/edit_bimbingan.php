...
$queryBimbingan = mysqli_query($koneksi, "SELECT *, mahasiswa.nim, dosen.nama as namados, mahasiswa.nama as namamah FROM bimbingan INNER JOIN dosen ON bimbingan.id_dosen=dosen.id_dosen 
                                                                                                                                              INNER JOIN mahasiswa ON bimbingan.id_mahasiswa=mahasiswa.id_mahasiswa WHERE id_bimbingan = '$id'");
