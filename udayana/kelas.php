                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <?php while($data = mysqli_fetch_assoc($queryKelas)) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($role == "2") { ?> 
                                                        <td><a href="kelas_edit.php?id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-primary ">Edit</a> | <a href="function.php?act=hapusKelas&id_kelas=<?= $data['id_kelas']; ?>" onclick="return confirm('Yakin ingin menghapus kelas?');" class="badge badge-danger ">Hapus</a> | <a href="kelas_lihat.php?id_kelas=<?= $data['id_kelas']; ?>" class="badge badge-secondary ">Lihat</a> </td>
                                                    <?php } ?>
